...
const SCHOOLS = {
  ...
  'EPA':          { district:'Aveiro',  specialty:'Tecnologias & Serviços',           color:'#0e7490', emoji:'🎓' },
  ...
  'EPCE Porto':   { district:'Porto',   specialty:'Comércio & Serviços Externos',     color:'#b45309', emoji:'🌐' },
...
const STUDENTS = [
  ...
  { id:'s1', name:'Carlos Oliveira', school:'EPA', level:'INTERMEDIO', rating:4.7, nServices:18, acceptProb:0.75, cats:['informatica'], location:'Aveiro',
    bio:'Curso de Informática na EPA. Suporte técnico, instalação de software e redes.',
    reviews:[
      {author:'João M.',text:'Muito profissional e rápido. Voltaria a contratar.',rating:5,date:'2026-04-10'},
      {author:'Ana S.',text:'Resolveu o problema de rede sem complicações.',rating:4,date:'2026-03-22'},
      {author:'Rui P.',text:'Instalou software sem complicações.',rating:5,date:'2026-03-05'},
      ...
      {author:'Marisa T.',text:'Problema de vírus resolvido rapidamente.',rating:5,date:'2026-01-15'},
      {author:'Hélder N.',text:'Bom serviço, honesto no preço.',rating:4,date:'2026-01-02'},
      {author:'Sofia R.',text:'Configuração de wi-fi feita com rigor.',rating:5,date:'2025-12-20'},
  ...
  { id:'n1',  name:'André Lopes',     school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['informatica'],  location:'Aveiro',
    bio:'Curso de Informática na EPA. Entusiasta de tecnologia, disponível para suporte e instalação.',
    reviews:[] },
  { id:'n2',  name:'Diogo Coelho',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['pintura'],      location:'Aveiro',
    bio:'Curso de Artes Visuais na EPA. Disponível para pintura de interiores e acabamentos.',
    reviews:[] },
  { id:'n3',  name:'Rodrigo Calado',  school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['jardinagem'],   location:'Aveiro',
    bio:'Curso de Ambiente e Território na EPA. Gosto de manter espaços verdes cuidados.',
    reviews:[] },
  { id:'n4',  name:'Eduardo Feio',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['babysitting'],  location:'Aveiro',
    bio:'Curso de Ação Social na EPA. Responsável e carinhoso com crianças.',
    reviews:[] },
  { id:'n5',  name:'Gabriel Santos',  school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['outros'],       location:'Aveiro',
    bio:'Curso Geral na EPA. Polivalente e disponível para serviços variados.',
    reviews:[] },
  { id:'n6',  name:'Gaspar Félix',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['eletric'],      location:'Aveiro',
    bio:'Curso de Instalações Elétricas na EPA. Disponível para instalações domésticas simples.',
    reviews:[] },
  { id:'n7',  name:'Santiago Roldão', school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['canaliza'],     location:'Aveiro',
    bio:'Curso de Construção Civil na EPA. Aprendo rápido e sou responsável.',
    reviews:[] },
  { id:'n8',  name:'Pedro Coutinho',  school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['canaliza'],     location:'Aveiro',
    bio:'Curso de Construção Civil na EPA. Disponível para trabalhos de canalização básica.',
    reviews:[] },
  { id:'n9',  name:'Caique Costa',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['carpint'],      location:'Aveiro',
    bio:'Curso de Carpintaria e Mobiliário na EPA. Gosto de trabalhar a madeira.',
    reviews:[] },
  { id:'n10', name:'Carlos Ferreira', school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['cozinhar'],     location:'Aveiro',
    bio:'Curso de Restauração na EPA. Disponível para preparação de refeições e apoio culinário.',
    reviews:[] },
  { id:'n11', name:'Artur Gaspar',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['soldadura'],    location:'Aveiro',
    bio:'Curso de Metalurgia na EPA. Soldadura básica e estruturas metálicas simples.',
    reviews:[] },
  { id:'n12', name:'Gonçalo Costa',   school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['pintura'],      location:'Aveiro',
    bio:'Curso de Artes Visuais na EPA. Criativo e atento ao detalhe na pintura decorativa.',
    reviews:[] },
  { id:'n13', name:'Manuel Resende',  school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['manutencao'],   location:'Aveiro',
    bio:'Curso de Manutenção Industrial na EPA. Disponível para pequenas reparações domésticas.',
    reviews:[] },
  { id:'n14', name:'João Resende',    school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['limpeza'],      location:'Aveiro',
    bio:'Curso de Serviços na EPA. Rigoroso e eficiente nas tarefas de limpeza.',
    reviews:[] },
  { id:'n15', name:'José Neto',       school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['seguranca'],    location:'Aveiro',
    bio:'Curso de Segurança e Vigilância na EPA. Instalação básica de câmaras e sistemas de alarme.',
    reviews:[] },
  { id:'n16', name:'Tomás Ramos',     school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['carpint'],      location:'Aveiro',
    bio:'Curso de Carpintaria e Mobiliário na EPA. Montagem e pequenas reparações de madeira.',
    reviews:[] },
  { id:'n17', name:'Tomás Neto',      school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['seguranca'],    location:'Aveiro',
    bio:'Curso de Segurança e Vigilância na EPA. Focado em sistemas de proteção residencial.',
    reviews:[] },
  { id:'n18', name:'João André',      school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['informatica'],  location:'Aveiro',
    bio:'Curso de Informática na EPA. Suporte técnico, redes e instalação de periféricos.',
    reviews:[] },
  { id:'n19', name:'Letícia Pedrosa', school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['informatica'],  location:'Aveiro',
    bio:'Curso de Informática na EPA. Apaixonada por tecnologia, disponível para suporte e instalação.',
    reviews:[] },
  { id:'n20', name:'Duarte Coutinho', school:'EPA', level:'BASICO',     rating:0,   nServices:0,  acceptProb:0.85, cats:['informatica'],  location:'Aveiro',
    bio:'Curso de Informática na EPA. Programação e suporte técnico a utilizadores.',
    reviews:[] },

  // ── EPCE Porto — Escola Profissional de Comércio Externo ──────
  // (sem alunos inicialmente, escola criada)

  // ── ETP Coimbra — novos alunos ────────────────────────────────
  { id:'n21', name:'Emilia Furtado',  school:'ETP Coimbra', level:'BASICO', rating:0, nServices:0, acceptProb:0.85, cats:['pintura'], location:'Coimbra',
    bio:'Curso de Artes & Acabamentos na ETP Coimbra. Disponível para pintura de interiores.',
    reviews:[] },

  // ── ETPL Lisboa — novos alunos ────────────────────────────────
  { id:'n22', name:'Rafael Clemente', school:'ETPL Lisboa', level:'BASICO', rating:0, nServices:0, acceptProb:0.85, cats:['manutencao'], location:'Lisboa',
    bio:'Curso de Manutenção na ETPL Lisboa. Disponível para pequenas reparações domésticas.',
    reviews:[] },
];
